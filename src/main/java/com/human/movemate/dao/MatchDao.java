...
public class MatchDao {
    ...
    public List<MatchingHistoryDto> findByNo(Long userNo) {
        ...
        MT.mate_no, MT.mate_type, MT.mate_name, MT.created_at, MT.sport_type AS sport_type,
        U_Author.name AS opponent_name, U_Author.user_id AS opponent_user_id,
        UP_Author.profile_image_url AS opponent_profile_image_url, UP_Author.region AS region
        FROM MATCHING M
        JOIN MATE MT ON M.mate_no = MT.mate_no
        ...
        UP_App.profile_image_url AS opponent_profile_image_url, UP_App.region AS regionn
        FROM MATCHING M
        JOIN MATE MT ON M.mate_no = MT.mate_no
